...
#### Задача OP-1: Оптимизация ререндеров компонентов
...
#### Задача OP-2: Улучшение алгоритма проверки и очистки линий
...
gantt
    ...
    section Оптимизация
    OP-1: Оптимизация ререндеров               :a1, 2025-04-14, 3d
    OP-2: Улучшение алгоритма очистки линий    :a2, after a1, 3d
    
    section Визуальное улучшение
    VA-1: Анимации размещения фигур            :b1, 2025-04-14, 3d
    VA-2: Анимации очистки линий               :b2, after b1, 4d
    VA-3: Анимации начисления очков            :b3, after b2, 3d
    
    section UX улучшения
    UX-1: Звуковые эффекты                     :c1, after a2, 4d
...
### Высокий приоритет:
1. OP-1: Оптимизация ререндеров компонентов
2. OP-2: Улучшение алгоритма проверки и очистки линий
3. VA-1: Улучшение анимаций размещения фигур
4. VA-2: Создание анимаций для очистки линий

### Средний приоритет:
1. VA-3: Добавление анимаций для начисления очков
2. UX-1: Добавление звуковых эффектов
3. SP-1: Реализация сохранения рекордов в localStorage
