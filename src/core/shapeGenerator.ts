...
const shapeDefinitions: Record<ShapeType, ShapeDefinition> = {
    ...
    [ShapeType.SINGLE]: {
        ...
        matrices: {
            [ShapeOrientation.DEGREES_0]: [[true]],
        },
    },
    ...
    [ShapeType.LINE_2]: {
        ...
        matrices: {
            [ShapeOrientation.DEGREES_0]: [[true, true]],
            [ShapeOrientation.DEGREES_90]: [[true], [true]],
        },
    },
    ...
    [ShapeType.LINE_3]: {
        ...
        matrices: {
            [ShapeOrientation.DEGREES_0]: [[true, true, true]],
            [ShapeOrientation.DEGREES_90]: [[true], [true], [true]],
        },
    },
...
function getRandomShapeType(params?: ShapeGenerationParams): ShapeType {
    ...
    const availableTypes = Object.values(ShapeType).filter(
        (type) => !params?.excludeTypes || !params.excludeTypes.includes(type)
    );
...
export function generateRandomShapes(count: number, params?: ShapeGenerationParams): Shape[] {
    return Array(count)
        .fill(null)
        .map(() => generateRandomShape(params));
}
...
export function getTutorialShapes(): Record<string, Shape> {
    ...
    Object.values(ShapeType).forEach((type) => {
        const orientation = Object.keys(
            shapeDefinitions[type].matrices
        )[0] as unknown as ShapeOrientation;
        result[type] = {
            id: `tutorial-${type}`,
            type,
            orientation,
